...
export function AnimatedFeaturesSection() {
  ...
  <div className="text-center mb-16">
    ...
    >
      مميزات قوية لطلبة الحقوق
    </h2>
    <p className="text-xl text-gray-300 max-w-2xl mx-auto">
      منصة مدعّمة بالذكاء الاصطناعي تضم أكثر من 5000 وثيقة من القانون التونسي لمساعدتك على الفهم، المراجعة، والنجاح في الامتحانات.
    </p>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
    <div className="md:col-span-2">
      <BentoCard
        title="مكتبة قانونية شاملة"
        value="+5000 وثيقة"
        subtitle="جميع مجلات القانون التونسي محدثة ومنظمة حسب الاختصاص والمستوى الجامعي"
    ...
    <BentoCard
      title="مساعد ذكي للطلبة"
      value="ذكاء اصطناعي"
      subtitle="شرح النصوص القانونية، تبسيط المفاهيم، والإجابة عن أسئلتك أثناء المراجعة"
      colors={["#151515", "#252525", "#1d1d1d"]}
      delay={0.4}
    />

    <BentoCard
      title="مراجعة أسرع وأسهل"
      value="فعّالة"
      subtitle="تسهيل الحفظ والفهم خلال فترة المراجعة والامتحانات"
    ...
    <div className="md:col-span-2">
      <BentoCard
        title="مناسبة لكل المستويات"
        value="1ᵉʳᵉ إلى ماستر"
        subtitle="موجهة لطلبة الإجازة، الماجستير، التكوين المهني وحتى المحامين"
    ...
    <div className="md:col-span-3">
      <BentoCard
        title="وصول سهل وآمن"
        value="24/7"
        subtitle="استخدم المنصة في أي وقت ومن أي جهاز مع تجربة استخدام سلسة"
